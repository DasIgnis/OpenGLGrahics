...
#include "task1/include/glm/glm.hpp"
#include "task1/include/glm/mat3x3.hpp"

#include "task1/include/glm/trigonometric.hpp"

#include "task1/include/glm/gtc/matrix_transform.hpp"
...
GLint  Attrib_vertex;
GLint  Unif_color;
string vsPath = "task1/vertex.shader";
string fsPath = "task1/fragment.shader";
...
void render2() {
	...
	static float red[4] = { 1.0f, 1.0f, 0.0f, 1.0f };
